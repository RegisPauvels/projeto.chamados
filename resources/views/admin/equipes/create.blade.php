<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-gray-800">Nova Equipe</h2>
    </x-slot>

    <div class="py-6 container mx-auto">
        <form action="{{ route('equipes.store') }}" method="POST" class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-sm">
            @csrf
            <div class="mb-4">
